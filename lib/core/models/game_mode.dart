...
extension GameModeConfig on GameMode {
  String get label {
    switch (this) {
      ...
      case GameMode.swap:
        return 'Swap';
      case GameMode.sixLetter:
        return '6-Letter';
      case GameMode.noYellowHints:
        return 'No Yellow';
      case GameMode.timed:
        return 'Timed';
      case GameMode.customWord:
        return 'Custom Words';
    }
  }
  ...
  String get description {
    switch (this) {
      case GameMode.daily:
        return 'One shared puzzle per day';
      case GameMode.classic:
        return '6 rows • 5 letters';
      case GameMode.swap:
        return 'Color meanings are shuffled (for fun)';
      case GameMode.sixLetter:
        return '6 rows • 6 letters';
      case GameMode.noYellowHints:
        return 'Only green/gray shown, no yellow hints';
      case GameMode.timed:
        return 'Solve under a time limit';
      case GameMode.customWord:
        return 'Play with Custom Words';
    }
  }

  bool get hasCustomWordManagement {
    return this == GameMode.customWord;
  }
}
